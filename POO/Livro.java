public class Livro {
    ...
    Livro(String titulo, String isbn, String materia, String edicao, String ano, String anoPublicacao){
        this.titulo = titulo;
        this.isbn = isbn;
    ...
    //Overloading (sem ano)
    Livro(String titulo, String isbn, String materia, String edicao, String ano){
        this.titulo = titulo;
        this.isbn = isbn;
        this.materia = materia;
        this.edicao = edicao;
